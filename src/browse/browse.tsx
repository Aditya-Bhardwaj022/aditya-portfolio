...
const Browse: React.FC = () => {
  ...
  const profiles = [
    ...
    },
    {
      name: "developer",
      image: greyImage,
      backgroundGif: "https://media1.tenor.com/m/DnMOr2rgYaQAAAAC/jim-carrey-jim-carrey-typing.gif" // Jim Carrey typing GIF
    },
    {
      name: "stalker",
      image: redImage,
      backgroundGif: "https://media1.tenor.com/m/27l-9pcdYwgAAAAC/conan-obrien.gif" // Conan O'Brien GIF
    },
    {
      name: "adventurer",
      image: yellowImage,
